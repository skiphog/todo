...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_uikit__ = __webpack_require__("./node_modules/uikit/dist/js/uikit.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  created: function created() {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_1__helpers_api__["c" /* interceptors */])(function (err) {
      ...
      if (err.response.status === 500) {
        __WEBPACK_IMPORTED_MODULE_2_uikit___default.a.notification(err.response.statusText, { status: 'danger' });
      }
  ...
  methods: {
    logout: function logout() {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_1__helpers_api__["d" /* post */])('/api/logout').then(function (res) {
        if (res.data.logged_out) {
          __WEBPACK_IMPORTED_MODULE_0__helpers_auth__["a" /* default */].remove();
          __WEBPACK_IMPORTED_MODULE_2_uikit___default.a.notification('Вы вышли', { status: 'success' });
          _this2.$router.push('/');
        }
      }).catch(function (err) {});
    }
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__helpers_auth__ = __webpack_require__("./resources/assets/js/helpers/auth.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_uikit__ = __webpack_require__("./node_modules/uikit/dist/js/uikit.js");
    ...
    log_in: function log_in() {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_2__helpers_api__["d" /* post */])('/api/login', this.form).then(function (res) {
        if (res.data.authenticated) {
          __WEBPACK_IMPORTED_MODULE_0__helpers_auth__["a" /* default */].set(res.data.api_token, res.data.user_id);
          __WEBPACK_IMPORTED_MODULE_1_uikit___default.a.notification("Вы успешно вошли", { status: 'success' });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    register: function register() {
      ...
      this.isProcessing = true;
      //this.error = {};
      Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["d" /* post */])('/api/register', this.form).then(function (res) {
        if (res.data.registered) {
          __WEBPACK_IMPORTED_MODULE_1_uikit___default.a.notification('Аккаунт успешно создан', { status: 'success' });
          _this.$router.push('/login');
        }
        _this.isProcessing = false;
      }).catch(function (err) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    changeChecked: function changeChecked(note, panel) {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["d" /* post */])('/api/note/' + note.id + '?_method=PUT', { checked: note.checked }).then(function (res) {
        //todo: что-то сдедать
      });
      this.reCheck(panel);
    },
  ...
  methods: {
    save: function save() {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_2__helpers_api__["d" /* post */])(this.storeUrl, form).then(function (res) {
        if (res.data.saved) {
          __WEBPACK_IMPORTED_MODULE_1_uikit___default.a.notification('Сохранено', { status: 'success' });
    ...
    removePanel: function removePanel() {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_2__helpers_api__["a" /* del */])('/api/dashboard/' + this.$route.params.id).then(function (res) {
        if (res.data.deleted) {
          __WEBPACK_IMPORTED_MODULE_1_uikit___default.a.notification('Удалено', { status: 'success' });
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-03bb1435\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/views/index.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-0c042eeb\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/views/not-found.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "uk-section uk-text-center" }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0c042eeb", module.exports)
  }
}
  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          staticClass:
            "uk-navbar-container uk-margin uk-navbar uk-box-shadow-medium navbar-todo",
          attrs: { "uk-navbar": "" }
        },
        [
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("div", { staticClass: "uk-container uk-margin-bottom" }, [
      _c(
        "ul",
        {
          ...
          _vm._l(_vm.pages, function(page) {
            return _c("li", [
              _c(
                "a",
                {
                  class: { "pagination-active": _vm.currentPage === page },
                  attrs: { href: "#" },
                  on: {
                    click: function($event) {
                      $event.preventDefault()
    ...
    _c("div", { staticClass: "uk-container uk-margin-bottom" }, [
      _c(
        "div",
        {
          staticClass: "uk-child-width-1-2@s uk-child-width-1-3@m",
          attrs: { "uk-grid": "" }
        },
            ...
            _c(
              ...
              [
                _c(
                  "router-link",
                  {
                    staticClass: "uk-card-badge",
                    attrs: { to: "/dashboard/" + item.id + "/edit" }
                  },
                  [_c("span", { attrs: { "uk-icon": "icon: cog" } })]
                ),
                _vm._v(" "),
                _c(
                  "h3",
    ...
    _c("div", { staticClass: "uk-section" }, [
        ...
        _c("div", { staticClass: "uk-flex uk-flex-center" }, [
          _c(
            "div",
            {
              ...
              attrs: { title: "Всего списков", "uk-tooltip": "" }
            },
            [
              _c("span", { attrs: { "uk-icon": "icon: database" } }),
              _vm._v(" " + _vm._s(_vm.info.count) + "\n                ")
            ]
          ),
          _vm._v(" "),
          _c(
            "div",
            {
              ...
              attrs: { title: "Выполнено", "uk-tooltip": "" }
            },
            [
              _c("span", { attrs: { "uk-icon": "icon: check" } }),
              _vm._v(" " + _vm._s(_vm.info.complete) + "\n                ")
            ]
          ),
          _vm._v(" "),
          _c(
            "div",
            {
              staticClass:
                "uk-card uk-card-default uk-card-body uk-margin-left",
              attrs: { title: "Не выполнено", "uk-tooltip": "" }
            },
            [
              _c("span", { attrs: { "uk-icon": "icon: bolt" } }),
              _vm._v(" " + _vm._s(_vm.info.incomplete) + "\n                ")
            ]
          )
        ])
      ]),
      ...
      _c("div", { staticClass: "uk-container uk-margin-bottom" }, [
        _c(
          "div",
          {
            staticClass: "uk-child-width-expand@s uk-text-center",
            attrs: { "uk-grid": "" }
          },
          [
            _c("div", [
              _c(
                "div",
                {
                  staticClass: "uk-card uk-card-default uk-card-body",
                  attrs: {
                    title: "Дата создания первого списка",
                    "uk-tooltip": ""
                  }
                },
                [
            ...
            _c("div", [
              _c(
                "div",
                {
                  staticClass: "uk-card uk-card-default uk-card-body",
                  attrs: {
                    title: "Дата создания последнего списка",
                    "uk-tooltip": ""
                  }
                },
                [
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_uikit__ = __webpack_require__("./node_modules/uikit/dist/js/uikit.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_uikit___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_uikit__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_uikit_dist_js_uikit_icons__ = __webpack_require__("./node_modules/uikit/dist/js/uikit-icons.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__router__ = __webpack_require__("./resources/assets/js/router/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__views_form_vue__ = __webpack_require__("./resources/assets/js/views/form.vue");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__views_form_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__views_form_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__views_index_vue__ = __webpack_require__("./resources/assets/js/views/index.vue");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__views_index_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__views_index_vue__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__views_auth_login_vue__ = __webpack_require__("./resources/assets/js/views/auth/login.vue");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__views_not_found_vue__ = __webpack_require__("./resources/assets/js/views/not-found.vue");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__views_not_found_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__views_not_found_vue__);
...
var router = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
  ...
  routes: [{ path: '/', component: __WEBPACK_IMPORTED_MODULE_3__views_index_vue___default.a }, { path: '/dashboard/:id/edit', component: __WEBPACK_IMPORTED_MODULE_2__views_form_vue___default.a, meta: { mode: 'edit' } }, { path: '/dashboard/create', component: __WEBPACK_IMPORTED_MODULE_2__views_form_vue___default.a, meta: { mode: 'update' } }, { path: '/register', component: __WEBPACK_IMPORTED_MODULE_7__views_auth_register_vue___default.a }, { path: '/login', component: __WEBPACK_IMPORTED_MODULE_5__views_auth_login_vue___default.a }, { path: '/dashboard', component: __WEBPACK_IMPORTED_MODULE_4__views_dashboard_vue___default.a }, { path: '/not-found', component: __WEBPACK_IMPORTED_MODULE_6__views_not_found_vue___default.a }, { path: '*', component: __WEBPACK_IMPORTED_MODULE_6__views_not_found_vue___default.a }]
});
...
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-03bb1435\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/views/index.vue")
/* template functional */
var __vue_template_functional__ = false
/* styles */
var __vue_styles__ = null
...
/***/ "./resources/assets/js/views/not-found.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var __vue_script__ = null
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-0c042eeb\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/views/not-found.vue")
/* template functional */
var __vue_template_functional__ = false
/* styles */
var __vue_styles__ = null
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0c042eeb", Component.options)
  } else {
    hotAPI.reload("data-v-0c042eeb", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
